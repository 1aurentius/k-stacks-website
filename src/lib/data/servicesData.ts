...
export const servicesData: Service[] = [
  ...
  },
  {
    ...
    catchphrase: 'Discover, build, ship, iterate.',
    description: "End-to-end product development — from validating the idea, to shipping the first version, to iterating based on real usage. Engineering depth with product thinking, and AI integrated where it genuinely earns its place.",
    items: [
