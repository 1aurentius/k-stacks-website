...
<section class="aboutus-section-marzipan" id="aboutus-section" use:observe>
  <div class="services-intro-text-container">
    <div class="services-intro-text">About me —</div>
    <p>
  ...
  <div class="aboutus-content-container">
    <div class="aboutus-iamge-column">
      <img
        src={kristerImage}
    ...
    <div class="aboutus-title-column">
      ...
      <div class="aboutus-social-links">
        <a
